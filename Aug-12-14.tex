...
into different sub-sets. Hence, we would want to compute the
partition. We try to cast this problem as a graph-theoretic problem. We will
see a solution to this in next lecture.
