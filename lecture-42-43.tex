...
Let us take a simple example. Let $a\Z$ and $b\Z$ be two ideals in $\Z$ such that gcd(a,b)=1. $\implies$ a,b are relatively prime. $\implies$ 1 \in a$\Z$ +  b$\Z$. $\implies \exists$ c, d suchthat ca+db=1. If an ideal contains 1, it contains $R$. $\implies a$\Z$ + b$\Z$ = 1 iff gcd(a,b)=1. 
