...
$H \lneq H' \lneq G$ where
$\lneq$ denotes strict subgroup containment.
\end{definition}
...
\begin{claim}
	For a group $G$ acting on $\Omega$, if there exists an $\alpha \in
	\Omega$ such that $G_\alpha$ is maximal subgroup of $G$, then for all
	$\beta \in \Omega$ $G_\beta$ is also maximal.
\end{claim}
\begin{proof}
