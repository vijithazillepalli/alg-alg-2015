...
\textbf{Output} : A Generating Set for $Aut(G)$.
\end{minipage}
}
...
\fbox{
\begin{minipage}{10 cm}\textbf{PROBLEM : NUMBER OF ISOMORPHISMS}\\
\textbf{Input} : A graph $G_1=(V_1,E_1),G_2=(V_2,E_2)$\\
\textbf{Output} : The number of Isomorphisms from $G_1$ to $G_2$.
\end{minipage}
}
...
\fbox{
\begin{minipage}{10 cm}\textbf{PROBLEM : NUMBER OF AUTOMORPHISMS}\\
\textbf{Input} : A graph $G=(V,E)$\\
\textbf{Output} : $\|Aut(G)\|$.
\end{minipage}
}
...
\fbox{
\begin{minipage}{10 cm}\textbf{PROBLEM : COMPUTING ISOMORPHISM}\\
\textbf{Input} : A graph $G_1=(V_1,E_1),G_2=(V_2,E_2)$\\
\textbf{Output} : A permutation that 'morphs' $G_1$ to $G_2$.
\end{minipage}
}
...
\fbox{
\begin{minipage}{10 cm}\textbf{PROBLEM : COMPUTING AUTOMORPHISM}\\
\textbf{Input} : A graph $G=(V,E)$\\
\textbf{Output} : A non-trivial element of $Aut(G)$.
\end{minipage}
}
